...
const experiences = [
	{
		...
		date: "2021 -  2025",
		points: [
			"Truffle Suite: A development environment,testing framework,asset pipeline for Ethereum smart contracts.",
			" Hardhat:  A flexible development environment for Ethereum that allows testing, deploying, and debugging smart contracts.",
			" OpenZeppelin: Library of secure, community-vetted smart contracts and tools for building on Ethereum",
			" Remix IDE: Web-based IDE for writing, compiling, and deploying Solidity smart."
		],
	},
	{
		title: "AI Engineer",
		...
		date: "2023 - 2025",
		points: [
			" TensorFlow: An open-source library developed by Google for machine learning and deep learning learning ",
			" PyTorch: Developed by Facebook, known for its dynamic computation graph ",
			"Keras: A high-level API that runs on top of TensorFlow,making model building more straightforward.",
			"Scikit-learn: A comprehensive library for traditional machine learning algorithms, data preprocessing, and model evaluation in Python.",
			" MXNet: A scalable deep learning library supported by Amazon Web Services.",
			"Caffe / Caffe2: Deep learning frameworks focused on speed and modularity, often used in computer vision"
		],
	},
	{
		title: "frontend Engineer",
		...
		date: "2017 - 2025",
		points: [
			"React.js: A library developed by Facebook for building component-based user interfaces. Very popular for its flexibility and large ecosystem.",
			" Angular: A comprehensive, full-featured framework developed by Google,suitable for large-scale applications.",
			" Vue.js: A progressive, lightweight framework that's easy to learn and integrates well with existing projects."
		]
	},
];
